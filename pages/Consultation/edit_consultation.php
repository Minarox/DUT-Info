...
<html>
	...
	<body>
		...
		<?php
			...
			if($requete->rowCount() == 1 && $_GET["Date_RDV"] != $_GET["Date_RDV"] && $_POST["Usager_RDV_A"] != $_POST["Medecin_RDV_A"] && $_POST["Heure_RDV"] != $_POST["Heure_RDV_A"]) {
				...
				if($requete->rowCount() == 1 && $_GET["Date_RDV"] != $_GET["Date_RDV"] && $_POST["Medecin_RDV_A"] != $_POST["Medecin_RDV_A"] && $_POST["Heure_RDV"] != $_POST["Heure_RDV_A"]) {
					echo('<div id="grande_boite">
					...
					if($requete_u->rowCount() >= 1) {
						while($data = $requete_u->fetch()){
							...
							if($duree_RDV == minutes($_POST["Heure_RDV_A"]) || $_POST["Duree_RDV"] == $_POST["Duree_RDV_A"]){
								$marqueur = 0;
							}
						...
						if($marqueur != 0){
							...
							$requete->execute(array($_POST["Date_RDV"], $_POST["Heure_RDV"], $_POST["Usager_RDV"], $_POST["Medecin_RDV"]));

...
<html lang="fr">
	<head>
		...
		<?php
			...
			$localisation = "Politique de confidentialité";
		?>
		<title>Politique de confidentialité | Ananké</title>
	</head>
	...
	<body>
		...
		<div id="position-contenu-page">
			...
			<div class="container-md pt-5 pb-4">
				...
				<p class="m-0 mt-4">
					<b>La gestion des impayés et du contentieux, à condition qu'elle ne porte pas sur des infractions et / ou qu'elle n'entraîne pas une exclusion de la personne du bénéfice d'un droit, d'une prestation ou d'un contrat</b>
				</p>
				...
				<p class="m-0 mt-2">
					<b>Aucune collecte des données de géolocalisation</b>
				</p>
				<p class="m-0 mt-2">
					Nous ne collectons et ne conservons aucune donnée de géolocalisation (déplacements, données GPS, GSM...).
				</p>
				...
				<p class="m-0 mt-4">
					<b>Droit de l'Utilisateur de refuser les cookies, la désactivation entraînant un fonctionnement dégradé du service</b>
				</p>
				<p class="m-0 mt-2">
				...
				<p class="m-0 mt-4">
					<b>Association possible des cookies avec des données personnelles pour permettre le fonctionnement du service</b>
				</p>
				<p class="m-0 mt-2">
